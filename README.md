...
> [@CinemaCityAppBot](https://t.me/CinemaCityAppBot) is the only mobile movie ticketing app that lets you buy movie tickets, make movie plans with friends & get a VIP experience at the theater so you never wait in line. When you get to movie theater, skip the box office line & scan your digital movie ticket with your phone.
...
Make sure you have both `cert.pem` and `key.pem` in your server's cert dir:
